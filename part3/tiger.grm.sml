\\062\000\059\000\060\000\094\000\
\\082\000\070\000\079\000\041\000\
\\024\000\028\000\012\000\012\000\
\\012\000\054\000\012\000\097\000\
\\032\000\042\000\030\000\023\000\
\\066\000\039\000\071\000\018\000\
\\012\000\019\000\086\000\035\000\
\\004\000\003\000\069\000\099\000\
\\012\000\055\000\012\000\098\000\
\\056\000\012\000\053\000\080\000\
\\040\000\086\000\083\000\089\000\
\\045\000\029\000\025\000\012\000\
\\012\000\031\000\073\000\100\000\
\\012\000\067\000\020\000\033\000\
\\012\000\026\000\021\000\037\000\
\\051\000\097\000\072\000\002\000\
\\085\000\084\000\090\000\012\000\
\\022\000\087\000\012\000\074\000\
\\091\000\043\000\086\000\005\000\
\\012\000\088\000\092\000\000\000"
val gotoT =
"\
\\001\000\139\000\002\000\002\000\016\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\002\000\028\000\016\000\001\000\000\000\
...
\\002\000\043\000\004\000\042\000\016\000\001\000\000\000\
\\000\000\
\\000\000\
\\017\000\044\000\000\000\
\\002\000\049\000\016\000\001\000\000\000\
...
\\000\000\
\\000\000\
\\007\000\035\000\008\000\066\000\009\000\033\000\010\000\032\000\
\\013\000\031\000\014\000\030\000\015\000\029\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\002\000\078\000\016\000\001\000\000\000\
\\002\000\080\000\003\000\079\000\016\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\002\000\043\000\004\000\082\000\005\000\081\000\016\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\002\000\087\000\016\000\001\000\000\000\
\\002\000\088\000\016\000\001\000\000\000\
\\002\000\089\000\016\000\001\000\000\000\
\\000\000\
...
\\002\000\103\000\016\000\001\000\000\000\
\\000\000\
...
\\000\000\
\\002\000\110\000\016\000\001\000\000\000\
\\017\000\111\000\000\000\
\\000\000\
\\002\000\113\000\016\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\002\000\119\000\016\000\001\000\000\000\
...
\\000\000\
\\000\000\
\\002\000\126\000\016\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\002\000\138\000\016\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\"
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | seqexp_p of unit ->  ( ( A.exp * pos )  list)
...
|  ( 12, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.seqexp_p 
seqexp_p1, _, _)) :: _ :: ( _, ( MlyValue.decls decls1, _, _)) :: ( _,
 ( _, (LETleft as LET1left), _)) :: rest671)) => let val  result = 
MlyValue.exp (fn _ => let val  (decls as decls1) = decls1 ()
 val  (seqexp_p as seqexp_p1) = seqexp_p1 ()
 in (makeLetExp(decls,A.SeqExp(seqexp_p),LETleft))
end)
...
|  ( 35, ( rest671)) => let val  result = MlyValue.seqexp_p (fn _ => (
[]))
 in ( LrTable.NT 4, ( result, defaultPos, defaultPos), rest671)
end
|  ( 36, ( ( _, ( MlyValue.seqexp seqexp1, seqexp1left, seqexp1right))
 :: rest671)) => let val  result = MlyValue.seqexp_p (fn _ => let val 
 (seqexp as seqexp1) = seqexp1 ()
 in (seqexp)
end)
 in ( LrTable.NT 4, ( result, seqexp1left, seqexp1right), rest671)
end
|  ( 37, ( rest671)) => let val  result = MlyValue.recfields (fn _ =>
 ([]))
...
|  ( 39, ( ( _, ( MlyValue.recfields recfields1, _, recfields1right))
...
MlyValue.recfields (fn _ => let val  (ID as ID1) = ID1 ()
 ...
 in ( LrTable.NT 5, ( result, ID1left, recfields1right), rest671)
end
|  ( 40, ( ( _, ( MlyValue.tydecls tydecls1, tydecls1left, 
tydecls1right)) :: rest671)) => let val  result = MlyValue.decl (fn _
 => let val  (tydecls as tydecls1) = tydecls1 ()
 in (A.TypeDec(tydecls))
end)
 in ( LrTable.NT 6, ( result, tydecls1left, tydecls1right), rest671)

end
|  ( 41, ( ( _, ( MlyValue.vardecl vardecl1, vardecl1left, 
...
|  ( 42, ( ( _, ( MlyValue.fundecls fundecls1, fundecls1left, 
fundecls1right)) :: rest671)) => let val  result = MlyValue.decl (fn _
 => let val  (fundecls as fundecls1) = fundecls1 ()
 in (A.FunctionDec(fundecls))
end)
 in ( LrTable.NT 6, ( result, fundecls1left, fundecls1right), rest671)

end
|  ( 43, ( rest671)) => let val  result = MlyValue.decls (fn _ => (nil
))
 in ( LrTable.NT 7, ( result, defaultPos, defaultPos), rest671)
end
|  ( 44, ( ( _, ( MlyValue.decls decls1, _, decls1right)) :: ( _, ( 
...
MlyValue.decls (fn _ => let val  (decl as decl1) = decl1 ()
 ...
 in ( LrTable.NT 7, ( result, decl1left, decls1right), rest671)
end
...
|  ( 46, ( ( _, ( MlyValue.tydecl tydecl1, tydecl1left, tydecl1right))
 :: rest671)) => let val  result = MlyValue.tydecls (fn _ => let val 
 (tydecl as tydecl1) = tydecl1 ()
 in ([tydecl])
end)
 in ( LrTable.NT 9, ( result, tydecl1left, tydecl1right), rest671)
end
|  ( 47, ( ( _, ( MlyValue.tydecl tydecl1, _, tydecl1right)) :: ( _, (
...
tydecls1 ()
 ...
 in ( LrTable.NT 9, ( result, tydecls1left, tydecl1right), rest671)
...
|  ( 50, ( ( _, ( MlyValue.ID ID1, IDleft, ID1right)) :: _ :: ( _, ( _
...
|  ( 52, ( ( _, ( MlyValue.ID ID2, ID2left, ID2right)) :: _ :: ( _, ( 
MlyValue.ID ID1, ID1left, _)) :: rest671)) => let val  result = 
...
|  ( 53, ( ( _, ( MlyValue.tyfields tyfields1, _, tyfields1right)) ::
...
|  ( 58, ( ( _, ( MlyValue.fundecl fundecl1, fundecl1left, 
fundecl1right)) :: rest671)) => let val  result = MlyValue.fundecls
 (fn _ => let val  (fundecl as fundecl1) = fundecl1 ()
 in ([fundecl])
end)
 in ( LrTable.NT 14, ( result, fundecl1left, fundecl1right), rest671)

end
|  ( 59, ( ( _, ( MlyValue.fundecl fundecl1, _, fundecl1right)) :: ( _
...
fundecls1) = fundecls1 ()
 ...
 in ( LrTable.NT 14, ( result, fundecls1left, fundecl1right), rest671)

end
|  ( 60, ( ( _, ( MlyValue.lvalue_p lvalue_p1, _, lvalue_p1right)) :: 
...
|  ( 61, ( rest671)) => let val  result = MlyValue.lvalue_p (fn _ => (
[]))
...
( _, ( MlyValue.ID ID1, _, _)) :: ( _, ( _, DOT1left, _)) :: rest671))
 ...
 in ( LrTable.NT 16, ( result, DOT1left, lvalue_p1right), rest671)
end
|  ( 63, ( ( _, ( MlyValue.lvalue_p lvalue_p1, _, lvalue_p1right)) ::
 ...
 in ( LrTable.NT 16, ( result, LBRACK1left, lvalue_p1right), rest671)
