...
fun yyAction55 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (currentString := !currentString ^ "\\" ^ yytext; YYBEGIN STRING;
					lineNum := !lineNum+1;
...
fun yyAction66 (strm, lastMatch : yymatch) = (yystrm := strm;
      (continue() (* WHAT DO YOU WANT CASPER? *) ))
        ...
        | SOME(inp, strm') =>
            if inp = #"g"
              ...
              then if inp = #"_"
                  ...
                  then if inp = #"^"
                      then yyQ119(strm', yyMATCH(strm, yyAction67, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction70(strm, yyNO_MATCH)
                      else yyQ67(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ67(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ73(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ72(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ67(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
              else yyAction70(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ105(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ67(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
              else yyAction70(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ110(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ109(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ67(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
              else yyAction70(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ115 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction69(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ115(strm', yyMATCH(strm, yyAction69, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ41 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction29(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ116(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
