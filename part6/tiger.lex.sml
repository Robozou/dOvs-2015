...
STRING | COMMENT | CONTROL | ESCAPE | INITIAL | IGNORE
...
fun yyAction59 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (currentString := !currentString ^ valOf(String.fromString("\\" ^ yytext)); YYBEGIN STRING; continue())
      end
...
fun yyAction62 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Invalid escape character " ^ yytext); YYBEGIN STRING; continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"g"
              ...
              then if inp = #"_"
                  ...
                  then if inp = #"^"
                      then yyQ120(strm', yyMATCH(strm, yyAction67, yyNO_MATCH))
                      else yyAction67(strm, yyNO_MATCH)
                else if inp = #"f"
                  then yyQ121(strm', yyMATCH(strm, yyAction67, yyNO_MATCH))
                  else yyAction67(strm, yyNO_MATCH)
            else if inp = #"o"
              then yyAction67(strm, yyNO_MATCH)
            else if inp < #"o"
              then if inp = #"n"
                  then yyQ122(strm', yyMATCH(strm, yyAction67, yyNO_MATCH))
                  else yyAction67(strm, yyNO_MATCH)
            else if inp = #"t"
              then yyQ123(strm', yyMATCH(strm, yyAction67, yyNO_MATCH))
              else yyAction67(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction70(strm, yyNO_MATCH)
                      else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ72(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ71(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ70(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ69(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"h"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ74(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ73(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
              else yyAction70(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ79(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ78(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"p"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ81(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ80(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"a"
              ...
              then if inp = #"i"
                  ...
                  then if inp = #"h"
                      then yyQ75(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
                      else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
                else if inp = #"o"
                  then yyQ76(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp = #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"z"
              then if inp = #"y"
                  then yyQ77(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
              else yyAction70(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ82(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"f"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ84(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ86(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ85(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ88(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"f"
                  then yyQ87(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
              else yyAction70(strm, yyNO_MATCH)
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ96(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ95(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ94(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ93(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"t"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ92(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"c"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ91(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ97(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ90(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"u"
              then if inp = #"o"
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ100(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"d"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ102(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ101(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"s"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ99(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"l"
                  then yyQ98(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
              else yyAction70(strm, yyNO_MATCH)
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ103(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ107(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ106(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
              else yyAction70(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ105(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ104(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ111(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ110(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
              else yyAction70(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ109(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction70(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ108(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction70(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction70, yyNO_MATCH))
       ...
       of NONE => yyAction26(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ113(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
...
fun yyQ116 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction69(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ116(strm', yyMATCH(strm, yyAction69, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ42 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction29(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ117(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"\\"
              ...
              then if inp = #"@"
                  ...
                  then yyAction62(strm, yyNO_MATCH)
                  else yyQ27(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp = #"^"
              then yyQ27(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp < #"^"
              then yyAction62(strm, yyNO_MATCH)
...
fun yyQ22 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction62(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"5"
              then yyQ29(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp < #"5"
              then if inp <= #"/"
                  then yyAction62(strm, yyNO_MATCH)
                  else yyQ28(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
              else yyAction62(strm, yyNO_MATCH)
      (* end case *))
fun yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction62(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ28(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp < #"0"
              then yyAction62(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ28(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp <= #"\b"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ19(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp = #" "
