...
L6_blocks:                                        # x86gen:131
	...
	movl -20(%ebp), %ebx                      # x86gen:448 x86frame:323
	movl $L1_string, %ebx                     # x86gen:448 x86frame:328
	movl %ebx, -20(%ebp)                      # x86gen:448 x86frame:333
	movl -28(%ebp), %ebx                      # x86gen:95 x86frame:301
...
L3_field_nonNil:                                  # x86gen:131
	...
	movl -36(%ebp), %eax                      # x86gen:283 x86frame:510
	...
	movl -44(%ebp), %eax                      # x86gen:338 x86frame:510
	movl -48(%ebp), %ebx                      # x86gen:338 x86frame:515
