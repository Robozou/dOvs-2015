...
L24_blocks:                                       # x86gen:128
	...
	movl -8(%ebp), %ebx                       # x86gen:293 x86frame:616
	movl %ebx, -12(%ebp)                      # x86gen:293 x86frame:620
	movl -12(%ebp), %ebx                      # x86gen:398 x86frame:377
	subl $5, %ebx                             # x86gen:398 x86frame:382
	movl %ebx, -12(%ebp)                      # x86gen:398 x86frame:387
...
L18_if_else:                                      # x86gen:128
	...
	movl -16(%ebp), %ebx                      # x86gen:293 x86frame:616
	movl %ebx, -20(%ebp)                      # x86gen:293 x86frame:620
	movl -20(%ebp), %ebx                      # x86gen:398 x86frame:377
	subl $1, %ebx                             # x86gen:398 x86frame:382
	movl %ebx, -20(%ebp)                      # x86gen:398 x86frame:387
	...
	movl %ebx, -84(%ebp)                      # x86gen:123 x86frame:620
L19_if_join:                                      # x86gen:128
	movl -84(%ebp), %ebx                      # x86gen:123 x86frame:616
	movl %ebx, -40(%ebp)                      # x86gen:123 x86frame:620
L22_if_join:                                      # x86gen:128
	movl -40(%ebp), %eax                      # x86gen:123 x86frame:609
...
L11_if_else:                                      # x86gen:128
	...
	addl $12, %esp                            # x86gen:55
	movl %eax, -52(%ebp)                      # x86gen:70 x86frame:602
...
L14_if_else:                                      # x86gen:128
	...
	movl -60(%ebp), %ecx                      # x86gen:310 x86frame:529
	movl -64(%ebp), %ebx                      # x86gen:310 x86frame:534
	subl %ecx, %ebx                           # x86gen:310 x86frame:539
	movl %ebx, -64(%ebp)                      # x86gen:310 x86frame:544
	movl -64(%ebp), %ebx                      # x86gen:228 x86frame:264
	pushl %ebx                                # x86gen:228 x86frame:269
	movl -72(%ebp), %ebx                      # x86gen:305 x86frame:323
	movl $0, %ebx                             # x86gen:305 x86frame:328
	movl %ebx, -72(%ebp)                      # x86gen:305 x86frame:333
	movl -68(%ebp), %ebx                      # x86gen:239 x86frame:343
	movl 12(%ebp), %ebx                       # x86gen:239 x86frame:348
	movl %ebx, -68(%ebp)                      # x86gen:239 x86frame:353
	movl -68(%ebp), %ecx                      # x86gen:310 x86frame:529
	movl -72(%ebp), %ebx                      # x86gen:310 x86frame:534
	subl %ecx, %ebx                           # x86gen:310 x86frame:539
	movl %ebx, -72(%ebp)                      # x86gen:310 x86frame:544
	movl -72(%ebp), %ebx                      # x86gen:228 x86frame:264
	pushl %ebx                                # x86gen:228 x86frame:269
	pushl %ebp                                # x86gen:228
	call L3_mod_pos                           # x86gen:68
	addl $12, %esp                            # x86gen:55
	movl %eax, -76(%ebp)                      # x86gen:70 x86frame:602
	movl -80(%ebp), %ebx                      # x86gen:305 x86frame:323
	movl $0, %ebx                             # x86gen:305 x86frame:328
	movl %ebx, -80(%ebp)                      # x86gen:305 x86frame:333
	movl -76(%ebp), %ecx                      # x86gen:310 x86frame:529
	movl -80(%ebp), %ebx                      # x86gen:310 x86frame:534
	subl %ecx, %ebx                           # x86gen:310 x86frame:539
	movl %ebx, -80(%ebp)                      # x86gen:310 x86frame:544
	movl -80(%ebp), %ebx                      # x86gen:123 x86frame:616
	movl %ebx, -108(%ebp)                     # x86gen:123 x86frame:620
...
L13_if_then:                                      # x86gen:128
	...
	movl -88(%ebp), %ebx                      # x86gen:239 x86frame:343
	movl 16(%ebp), %ebx                       # x86gen:239 x86frame:348
	movl %ebx, -88(%ebp)                      # x86gen:239 x86frame:353
	movl -88(%ebp), %ecx                      # x86gen:310 x86frame:529
	movl -92(%ebp), %ebx                      # x86gen:310 x86frame:534
	subl %ecx, %ebx                           # x86gen:310 x86frame:539
	movl %ebx, -92(%ebp)                      # x86gen:310 x86frame:544
	movl -92(%ebp), %ebx                      # x86gen:228 x86frame:264
	pushl %ebx                                # x86gen:228 x86frame:269
	movl -100(%ebp), %ebx                     # x86gen:305 x86frame:323
	movl $0, %ebx                             # x86gen:305 x86frame:328
	movl %ebx, -100(%ebp)                     # x86gen:305 x86frame:333
	movl -96(%ebp), %ebx                      # x86gen:239 x86frame:343
	movl 12(%ebp), %ebx                       # x86gen:239 x86frame:348
	movl %ebx, -96(%ebp)                      # x86gen:239 x86frame:353
	movl -96(%ebp), %ecx                      # x86gen:310 x86frame:529
	movl -100(%ebp), %ebx                     # x86gen:310 x86frame:534
	subl %ecx, %ebx                           # x86gen:310 x86frame:539
	movl %ebx, -100(%ebp)                     # x86gen:310 x86frame:544
	movl -100(%ebp), %ebx                     # x86gen:228 x86frame:264
	pushl %ebx                                # x86gen:228 x86frame:269
	pushl %ebp                                # x86gen:228
	call L2_mod_neg                           # x86gen:68
	addl $12, %esp                            # x86gen:55
	movl %eax, -104(%ebp)                     # x86gen:70 x86frame:602
	movl -112(%ebp), %ebx                     # x86gen:305 x86frame:323
	movl $0, %ebx                             # x86gen:305 x86frame:328
	movl %ebx, -112(%ebp)                     # x86gen:305 x86frame:333
	movl -104(%ebp), %ecx                     # x86gen:310 x86frame:529
	movl -112(%ebp), %ebx                     # x86gen:310 x86frame:534
	subl %ecx, %ebx                           # x86gen:310 x86frame:539
	movl %ebx, -112(%ebp)                     # x86gen:310 x86frame:544
...
L9_while_body:                                    # x86gen:128
	...
	movl -16(%ebp), %ecx                      # x86gen:329 x86frame:529
	movl -20(%ebp), %ebx                      # x86gen:329 x86frame:534
	subl %ebx, %ecx                           # x86gen:329 x86frame:539
	movl %ebx, -20(%ebp)                      # x86gen:329 x86frame:544
...
L4_done_label:                                    # x86gen:128
	...
	movl 12(%ebp), %ebx                       # x86gen:239 x86frame:348
	movl %ebx, -8(%ebp)                       # x86gen:239 x86frame:353
	movl -8(%ebp), %eax                       # x86gen:123 x86frame:609
	jmp L33_block_done                        # x86gen:191
L6_while_body:                                    # x86gen:128
	movl -12(%ebp), %ebx                      # x86gen:239 x86frame:343
	movl 12(%ebp), %ebx                       # x86gen:239 x86frame:348
	movl %ebx, -12(%ebp)                      # x86gen:239 x86frame:353
	movl -12(%ebp), %ebx                      # x86gen:304 x86frame:616
	movl %ebx, -20(%ebp)                      # x86gen:304 x86frame:620
	movl -16(%ebp), %ebx                      # x86gen:239 x86frame:343
	movl 16(%ebp), %ebx                       # x86gen:239 x86frame:348
	movl %ebx, -16(%ebp)                      # x86gen:239 x86frame:353
	movl -16(%ebp), %ecx                      # x86gen:309 x86frame:529
	movl -20(%ebp), %ebx                      # x86gen:309 x86frame:534
	addl %ecx, %ebx                           # x86gen:309 x86frame:539
	movl %ebx, -20(%ebp)                      # x86gen:309 x86frame:544
	movl -20(%ebp), %ebx                      # x86gen:91 x86frame:279
	movl %ebx, 12(%ebp)                       # x86gen:91 x86frame:284
