...
L2_blocks:                                        # x86gen:128
	...
	movl %ebx, -12(%ebp)                      # x86gen:357 x86frame:595
	movl $3, %ebx                             # x86gen:477 x86frame:328
	movl %ebx, -8(%ebp)                       # x86gen:477 x86frame:333
	movl -8(%ebp), %ecx                       # x86gen:362 x86frame:529
	movl -12(%ebp), %ebx                      # x86gen:362 x86frame:534
	imull %ecx, %ebx                          # x86gen:362 x86frame:539
	movl %ebx, -12(%ebp)                      # x86gen:362 x86frame:544
