...
L6_if_join:                                       # x86gen:131
	movl -56(%ebp), %eax                      # x86gen:127 x86frame:560
	jmp L12_block_done                        # x86gen:191
L4_if_then:                                       # x86gen:131
	...
	movl %ebx, -60(%ebp)                      # x86gen:127 x86frame:581
	movl 12(%ebp), %ebx                       # x86gen:239 x86frame:343
	...
	call ord                                  # x86gen:68
	addl $8, %esp                             # x86gen:55
	movl %eax, -36(%ebp)                      # x86gen:70 x86frame:558
	movl %ebx, -36(%ebp)                      # x86gen:127 x86frame:573
	movl -36(%ebp), %ebx                      # x86gen:127 x86frame:577
	movl %ebx, -44(%ebp)                      # x86gen:127 x86frame:581
