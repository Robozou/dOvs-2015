...
L7_blocks:                                        # x86gen:131
	...
	movl -32(%ebp), %ecx                      # x86gen:174 x86frame:306
...
L4_for_next:                                      # x86gen:131
	...
	movl -28(%ebp), %ebx                      # x86gen:174 x86frame:301
	movl -32(%ebp), %ecx                      # x86gen:174 x86frame:306
	cmpl %ebx, %ecx                           # x86gen:174 x86frame:311
...
L3_for_body:                                      # x86gen:131
	...
	movl %ebx, -36(%ebp)                      # x86gen:263 x86frame:573
	movl -36(%ebp), %ebx                      # x86gen:263 x86frame:577
	movl %ebx, -40(%ebp)                      # x86gen:263 x86frame:581
	movl -40(%ebp), %ebx                      # x86gen:267 x86frame:367
...
L2_mtseq:                                         # x86gen:131
	...
	movl %ebx, -44(%ebp)                      # x86gen:263 x86frame:573
	movl -44(%ebp), %ebx                      # x86gen:263 x86frame:577
	movl %ebx, -48(%ebp)                      # x86gen:263 x86frame:581
	movl -48(%ebp), %ebx                      # x86gen:267 x86frame:367
	addl $1, %ebx                             # x86gen:267 x86frame:372
