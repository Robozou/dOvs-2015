...
fun yyAction60 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Invalid escape character " ^ yytext); eof())
      end
...
fun yyAction63 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("Invalid character in ignore. No support for " ^ yytext); eof())
      end
       ...
       of NONE => yyAction61(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp <= #"\b"
                  then yyAction61(strm, yyNO_MATCH)
                  else yyQ118(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
            else if inp = #" "
              then yyQ118(strm', yyMATCH(strm, yyAction61, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction65(strm, yyNO_MATCH)
                      else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ70(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ68(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ71(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ75(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then if inp = #"h"
                  then yyQ73(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ78(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"f"
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ79(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"i"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ81(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ84(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"f"
                  then yyQ83(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ88(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"c"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ87(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ93(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ86(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"u"
              then if inp = #"o"
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ96(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"d"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ95(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"n"
              then if inp = #"l"
                  then yyQ94(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ99(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ103(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"k"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ102(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ101(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ100(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ108(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ107(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ106(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ109(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"d"
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ105(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"n"
                  then yyQ104(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                  else yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ66(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
...
fun yyQ46 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction22(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ110(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction64(strm, yyNO_MATCH)
                      else yyQ114(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction64(strm, yyNO_MATCH)
                  else yyQ66(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
            else if inp = #"`"
              then yyAction64(strm, yyNO_MATCH)
            else if inp < #"`"
              then if inp = #"_"
                  then yyQ66(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
...
fun yyQ3 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"\\"
              then yyQ28(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"\\"
              then if inp = #"+"
                  then yyQ36(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp < #"+"
                  then if inp = #"\""
                      then yyQ31(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp < #"\""
                      then if inp = #"\v"
                          then yyQ28(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                        else if inp < #"\v"
                          then if inp = #"\t"
                              then yyQ29(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                            else if inp = #"\n"
                              then yyQ9(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                              else yyQ28(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                        else if inp = #" "
                          then yyQ30(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                          else yyQ28(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #"("
                      then yyQ33(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp < #"("
                      then if inp = #"&"
                          then yyQ32(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                          else yyQ28(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #")"
                      then yyQ34(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ35(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #";"
                  then yyQ43(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp < #";"
                  then if inp = #"/"
                      then yyQ40(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp < #"/"
                      then if inp = #"-"
                          then yyQ38(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                        else if inp = #","
                          then yyQ37(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                          else yyQ39(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #":"
                      then yyQ42(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ41(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"?"
                  then yyQ28(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp < #"?"
                  then if inp = #"="
                      then yyQ45(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #"<"
                      then yyQ44(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ46(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"A"
                  then yyQ47(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp < #"A"
                  then yyQ28(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"["
                  then yyQ48(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                  else yyQ47(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp = #"l"
              then yyQ57(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"l"
              then if inp = #"c"
                  then yyQ47(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp < #"c"
                  then if inp = #"`"
                      ...
                      then if inp = #"^"
                          then yyQ50(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                        else if inp = #"]"
                          then yyQ49(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                          else yyQ47(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #"a"
                      then yyQ51(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ52(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"g"
                  then yyQ47(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp < #"g"
                  then if inp = #"e"
                      then yyQ54(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #"d"
                      then yyQ53(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ55(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"i"
                  then yyQ56(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                  else yyQ47(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp = #"v"
              then yyQ61(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"v"
              then if inp = #"p"
                  then yyQ47(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp < #"p"
                  then if inp = #"n"
                      then yyQ58(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #"m"
                      then yyQ47(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ59(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"t"
                  then yyQ60(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                  else yyQ47(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp = #"|"
...
fun yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\\"
              then yyQ24(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"\\"
              then if inp = #"@"
                  then yyQ24(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                else if inp < #"@"
                  ...
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ24(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp = #"^"
              then yyQ24(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"^"
              then yyAction60(strm, yyNO_MATCH)
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"5"
              ...
              then if inp <= #"/"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ25(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
              else yyAction60(strm, yyNO_MATCH)
      (* end case *))
fun yyQ18 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ25(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"0"
              then yyAction60(strm, yyNO_MATCH)
            else if inp <= #"9"
              then yyQ25(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
       ...
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\v"
              ...
              then if inp <= #"\b"
                  then yyAction59(strm, yyNO_MATCH)
                  else yyQ16(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp = #" "
