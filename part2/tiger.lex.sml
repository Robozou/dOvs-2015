        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction65(strm, yyNO_MATCH)
                      else yyQ63(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ99(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction65(strm, yyNO_MATCH)
                  else yyQ104(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ63(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
              else yyAction65(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction65(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"`"
              ...
              then yyQ102(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"n"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction64(strm, yyNO_MATCH)
                      else yyQ111(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction64(strm, yyNO_MATCH)
                  else yyQ63(strm', yyMATCH(strm, yyAction64, yyNO_MATCH))
            else if inp = #"`"
              then yyAction64(strm, yyNO_MATCH)
            else if inp < #"`"
              then if inp = #"_"
...
fun yyQ3 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"\\"
              then yyQ25(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp < #"\\"
              then if inp = #"+"
                  ...
                  then if inp = #"\""
                      ...
                      then if inp = #"\v"
                          ...
                          then if inp = #"\t"
                              then yyQ26(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                            else if inp = #"\n"
                              then yyQ9(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                              else yyQ25(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                        else if inp = #" "
                          then yyQ27(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                          else yyQ25(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #"("
                      ...
                      else yyQ32(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #";"
                  ...
                  then if inp = #"/"
                      ...
                      then if inp = #"-"
                          then yyQ35(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                        else if inp = #","
                          then yyQ34(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                          else yyQ36(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #":"
                      then yyQ39(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ38(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"?"
                  then yyQ25(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp < #"?"
                  then if inp = #"="
                      ...
                      then yyQ41(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ43(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"A"
                  ...
                  else yyQ44(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
            else if inp = #"l"
              ...
              then if inp = #"c"
                  ...
                  then if inp = #"`"
                      ...
                      then if inp = #"^"
                          ...
                          then yyQ46(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                          else yyQ44(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #"a"
                      then yyQ48(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ49(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"g"
                  then yyQ44(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp < #"g"
                  then if inp = #"e"
              ...
              then if inp = #"p"
                  ...
                  then if inp = #"n"
                      then yyQ55(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                    else if inp = #"m"
                      then yyQ44(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                      else yyQ56(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"t"
              ...
              then if inp = #"x"
                  ...
                  then yyQ59(strm', yyMATCH(strm, yyAction65, yyNO_MATCH))
                else if inp = #"{"
        ...
        | SOME(inp, strm') =>
            if inp = #"\\"
              ...
              then if inp = #"@"
                  ...
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ23(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp = #"^"
              then yyQ23(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"^"
              then yyAction60(strm, yyNO_MATCH)
