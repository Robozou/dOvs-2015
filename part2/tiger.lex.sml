        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction63(strm, yyNO_MATCH)
                      else yyQ61(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction63(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction63(strm, yyNO_MATCH)
                  else yyQ102(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ61(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
              else yyAction63(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction21(strm, yyNO_MATCH)
                      else yyQ61(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction21(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction62(strm, yyNO_MATCH)
                      else yyQ109(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction62(strm, yyNO_MATCH)
                  else yyQ61(strm', yyMATCH(strm, yyAction62, yyNO_MATCH))
            else if inp = #"`"
              then yyAction62(strm, yyNO_MATCH)
            else if inp < #"`"
              then if inp = #"_"
        ...
        | SOME(inp, strm') =>
            if inp = #"]"
              ...
              then if inp = #"-"
                  ...
                  then if inp = #"\""
                      then yyQ28(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                    else if inp < #"\""
                      then if inp = #"\v"
                          then yyQ25(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                        else if inp < #"\v"
                          then if inp = #"\t"
                              then yyQ26(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                            else if inp = #"\n"
                              then yyQ9(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                              else yyQ25(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                        else if inp = #" "
                          then yyQ27(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                          else yyQ25(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                    else if inp = #"*"
                      then yyQ31(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                    else if inp < #"*"
                      then if inp = #"("
                          then yyQ29(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                        else if inp = #")"
                          then yyQ30(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                          else yyQ25(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                    else if inp = #"+"
                      then yyQ32(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                      else yyQ33(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp = #"="
                  ...
                  then if inp = #":"
                      ...
                      then if inp = #"/"
                          ...
                          else yyQ37(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                    else if inp = #";"
                      then yyQ39(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                      else yyQ40(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp = #"A"
                  then yyQ43(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp < #"A"
                  then if inp = #">"
              ...
              then if inp = #"d"
                  then yyQ49(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                else if inp < #"d"
                  then if inp = #"a"
                      then yyQ47(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                    else if inp < #"a"
                      then if inp = #"_"
                          then yyQ43(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                        else if inp = #"^"
              ...
              then if inp = #"t"
                  ...
                  then yyQ43(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
                  else yyQ57(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp = #"|"
              then yyQ25(strm', yyMATCH(strm, yyAction63, yyNO_MATCH))
            else if inp < #"|"
              then if inp = #"{"
        ...
        | SOME(inp, strm') =>
            if inp = #"\\"
              ...
              then if inp = #"@"
                  ...
                  then yyAction58(strm, yyNO_MATCH)
                  else yyQ23(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp = #"^"
              then yyQ23(strm', yyMATCH(strm, yyAction58, yyNO_MATCH))
            else if inp < #"^"
              then yyAction58(strm, yyNO_MATCH)
       ...
       of NONE => yyAction57(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\n"
              ...
              then if inp = #"\t"
                  then yyQ24(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
